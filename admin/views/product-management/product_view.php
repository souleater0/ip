        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <div class="row align-items-stretch gy-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <span class="text-dark fw-semibold ">Product Name: </span><br><span class="text-dark">Powdered Milk</span>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <span class="text-dark fw-semibold ">Barcode: </span><br><?php echo "<img src='data:image/png;base64," . base64_encode(generateBarcode("P0000004")) . "' width='180'>";?><br><span class="text-dark">P0000004</span>
                    </div>
                </div>
